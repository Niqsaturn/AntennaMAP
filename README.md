...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\update_desktop_install.ps1
```

### Windows PowerShell (custom path)

```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\update_desktop_install.ps1 -InstallDir "C:\Users\<you>\Desktop\AntennaMAP" -Branch main
```
