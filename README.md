...
## Update existing desktop installation

### Windows PowerShell (Desktop default path)

```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\update_desktop_install.ps1 -RepoUrl https://github.com/your-github-username/AntennaMAP.git
```

### Windows PowerShell (custom path)

```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\update_desktop_install.ps1 -InstallDir "C:\Users\<you>\AntennaMAP" -Branch main -RepoUrl https://github.com/your-github-username/AntennaMAP.git
```

### macOS / Linux

```bash
./scripts/update_desktop_install.sh
# or custom path/branch:
./scripts/update_desktop_install.sh "$HOME/Desktop/AntennaMAP" main
```
